...
public:
    ...
    symbolInfo(string n, string t="", string ts="",int sz=0,int off=0){
...
public:
    ...
    nonTerminal(symbolInfo *si): symbolInfo(si->name, si->type, si->typeSpecifier, si->size, si->offset){
    ...
    nonTerminal(nonTerminal &n) : symbolInfo(n.name, n.type, n.typeSpecifier, n.size, n.offset)
    {
        
        code = n.code;
        sibling = n.sibling;
        child = n.child;
        arrayIndexAddress = n.arrayIndexAddress;


    }
    nonTerminal(string n, string t="", string ts="",int sz=0,string cd="",int off=0): symbolInfo(n,t,ts,sz,off){
    ...
    void setArrayIndexAddress(int indxadd){
    	arrayIndexAddress = indxadd;
    }
