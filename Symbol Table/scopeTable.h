...
public:
    ...
    scopeTable(int n, scopeTable *ps=nullptr){
        ...
        cout << "New ScopeTable with id " << tableId << " created." << endl;
    ...
    bool insertIntoTable(string name, string type){
        ...
        if(position == -1)
            ...
            cout << "Inserted in ScopeTable #" << tableId << " at position " << index << ", " << position << endl;
    ...
    symbolInfo *lookUp(string name){
        ...
        if(found != nullptr)
            cout << "Found in ScopeTable #" << tableId << " at position " << index << ", " << position << "." << endl;
        return found;
    ...
    bool deleteFromTable(string name){
        ...
        if(toDelete == nullptr) {
            ...
            cout << "Deleted entry " << index << ", " << position << " from current ScopeTable." << endl;
        }
    ...
    ~scopeTable(){
        ...
        cout << "Scopetable with id " << tableId << " removed. " << endl;
    }
